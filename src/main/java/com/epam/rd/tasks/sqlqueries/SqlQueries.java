...
public class SqlQueries {
    ...
    //language=HSQLDB
    String select04 = "SELECT * FROM EMPLOYEE WHERE SALARY >= 3000 OR SALARY <= 2000";
    ...
    //language=HSQLDB
    String select06 = "SELECT e.*, d.NAME as DEPNAME FROM DEPARTMENT d RIGHT JOIN EMPLOYEE e ON d.ID = e.DEPARTMENT";
    ...
    //language=HSQLDB
    String select08 = "SELECT d.NAME as DEPNAME, COUNT(*) AS STAFF_SIZE FROM DEPARTMENT d INNER JOIN EMPLOYEE e ON d.ID = e.DEPARTMENT GROUP BY d.NAME";
    //should use right join instead of inner join if null results are needed

    //Select all departments and values of total and average salary per department
    //Name column containing name of the department "depname".
    //language=HSQLDB
    String select09 = "SELECT d.NAME as DEPNAME, AVG(e.SALARY) as AVERAGE, SUM(e.SALARY) AS TOTAL FROM DEPARTMENT d INNER JOIN EMPLOYEE e ON d.ID = e.DEPARTMENT GROUP BY d.NAME";
